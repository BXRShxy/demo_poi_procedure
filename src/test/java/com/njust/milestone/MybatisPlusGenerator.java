...
//        dsc.setUrl("jdbc:mysql://localhost:3306/demo_shiro?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setUrl("jdbc:mysql://58.213.48.27:3306/demo_poi?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("lyw123456");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.njust.milestone1");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
...
//        pc.setServiceImpl("serviceImpl");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/com/njust/milestone1/mapper/"
        ...
        strategy.setTablePrefix("lcb_");  //表前缀，添加该表示，则生成的实体，不会有表前缀，比如sys_dept 生成就是Dept
//        strategy.setTablePrefix("");
//        strategy.setFieldPrefix("lcb_");  //字段前缀
